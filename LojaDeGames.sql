...
-- Lista de apenas 5 produtos da tabela categorias
SELECT * FROM tb_produtos INNER JOIN tb_categorias ON tb_produtos.categoria_id = tb_categorias.id

-- Lista os produtos de aventura da tabela produtos
WHERE tb_categorias.tipo = "aventura" ORDER BY tb_produtos.nome;

-- Fizemos um JOIN juntando duas tabelas
SELECT * FROM tb_produtos INNER JOIN tb_usuarios on tb_produtos.usuario_id = tb_usuarios;

-- Fizemos uma junção das três tabelas
